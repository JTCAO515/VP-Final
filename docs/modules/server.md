...
P0-04c (#168) switches routers/Web consumers and removes the legacy snapshot authority. Until that
consumer switch completes, both contracts coexist deliberately and deployed Trip mutation is not
production-safe.
