...
Planning documents are time-bound inputs, not proof that functionality exists.

| Document                                                                  | Status                      | Meaning                                                                                           |
| ------------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------- |
| [V2 Final Architecture](visepanda-v2-final-architecture.md)               | Frozen baseline             | Product and architecture direction; amend through a diff or superseding ADR                       |
...
| [VisePod Investor Prototype Amendment](visepod-investor-prototype-amendment.md) | Draft amendment | Controlled 3–5 device value hypothesis, investor story, comparison method, and continue/adjust/stop gates |
