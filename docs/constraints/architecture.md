...
- Scoped execution facts MUST use exactly one closed POI, city, scene, or China-national target. Their
  eligibility and conflict rules MUST remain identical to legacy POI facts; target scope is not
  evidence and cannot make a fact public.
