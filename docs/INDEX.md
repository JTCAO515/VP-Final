...
| --- | --- | --- |
| P0 | Observe the deployed P0-20 controls without weakening their fail-closed behavior, then complete only separately authorized release/runbook work whose external prerequisites are evidenced. | The operator-action register contains required sanitized deployment observations; no public capability is described as live before that evidence exists. |
