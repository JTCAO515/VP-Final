...
| --- | --- | --- |
| P1 | Implement Issue #124's traveler-facing Rescue Mode consumer from the merged deterministic routing contract, keeping every unavailable operational handoff hidden or explicitly unavailable. | The UI routes emergency categories to official guidance, never auto-submits Human Help, and only renders configured operational availability. Tests prove missing scope cannot produce a success, price, SLA, or medical/legal promise. |
