...
- **Updated:** 2026-08-13 by Codex / serialized post-#371-#376 public-runtime-safety refresh
- **Base branch:** `main`
- **Last fully verified commit:** `5b9a6c5 feat(web): add safe Copilot error recovery; PR #376 head passed GitHub verify, evals, Database contracts, and Documentation Governance before merge`
...
- **Last completed control action:** PRs #371 through #376 merged serially after real GitHub gates. #372 applies the ADR-0015 model-output ceiling; #373 applies the public Copilot input boundary; #374 adds the verified-account HMAC/Upstash window; #375 adds the verified-traveler China-day Human Help cap while preserving idempotency; and #376 adds the safe Web recovery boundary and correlation-only Copilot route logger. Issue #157 / P0-20 was closed with its evidence comment after GitHub verify, evals, Database contracts, and Documentation Governance succeeded. Production purge evidence remains verified under #311; payment remains deferred under P0-17 / OA-006.
