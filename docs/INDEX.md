...
| [VisePod Documentation](visepod/README.md) | reference | draft | operator / architecture | Reading order, prototype boundary, non-capabilities, and evidence rule for the VisePod initiative. |
| [VisePod Investor Prototype Amendment](planning/visepod-investor-prototype-amendment.md) | planning | draft | operator / architecture | Controlled three-to-five-device value hypothesis, investor story, comparison protocol, and lifecycle gates. |
