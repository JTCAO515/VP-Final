...
| [ADR-0015](ADR-0015-public-runtime-safety-control.md)                  | Proposed | Defines the bounded, truthful public-runtime control plane for P0-20 without duplicating existing owners.                                 |
