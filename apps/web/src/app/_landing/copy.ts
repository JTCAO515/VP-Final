...
// Keep this client-side ordering small. page.test.tsx proves it remains identical to the
// domain-owned enum, so the browser does not need to import the full domain package at runtime.
...
const en: LandingCopy = {
  ...
  eyebrow: "Free early access for independent travelers",
  ...
  scenariosEyebrow: "One workspace, three travel moments",
...
const zh: LandingCopy = {
  ...
  scenariosEyebrow: "一个工作台，覆盖三个旅行时刻",
...
const es: LandingCopy = {
  ...
  eyebrow: "Acceso anticipado gratuito para viajeros independientes",
  ...
  scenariosEyebrow: "Un espacio de trabajo, tres momentos de viaje",
...
const ru: LandingCopy = {
  ...
  eyebrow: "Бесплатный ранний доступ для самостоятельных путешественников",
  ...
  scenariosEyebrow: "Одно рабочее пространство, три момента поездки",
...
const ar: LandingCopy = {
  ...
  eyebrow: "وصول مبكر مجاني للمسافرين المستقلين",
  ...
  scenariosEyebrow: "مساحة عمل واحدة، ثلاث لحظات للسفر",
