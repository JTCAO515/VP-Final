...
import { resolveRuntimeMode } from "./runtime/runtimeMode.js";

export type WebTrustedEnvironment = Readonly<Record<string, string | undefined>>;
...
export function resolveTrustedClientAddress(
  headers: Headers,
  environment: WebTrustedEnvironment,
): string {
